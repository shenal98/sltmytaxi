    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #080078;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link active" href="trip_history.php">Trip History <span class="sr-only">(current)</span></a>
    ...
    <div class="container" style="margin-top: 2%;height: 100vh;">
        ...
        <table id='tblTrip' class="table table-bordered table-hover dt-responsive" style=" width: 100%; ">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td><?php echo $row['timeMill']; ?></td>
                            <td><?php echo $row['phoneTxt']; ?></td>
                            <td><?php echo $row['vnoTxt']; ?></td>
                            <td><?php echo $row['dateTxt']; ?></td>
                            <td><?php echo $row['distance']; ?></td>
                            <td><?php echo $row['oneKmRateTxt']; ?></td>
                            <td><?php echo $row['twoKmRate']; ?></td>
                            <td><?php echo $row['waitRate']; ?></td>
                            <td><?php echo $row['totFare']; ?></td>
                            <td><?php echo $row['startTime']; ?></td>
                            <td><?php echo $row['waitTime']; ?></td>
                            <td><?php echo $row['endTime']; ?></td>
                            <td><?php echo $row['totHireTime']; ?></td>
                            <td>
                                <form method='post' action="process.php">
                                    <input type="hidden" name="ref_toke_delete" value="<?php echo $key; ?>">

                                    <button type="submit" value="delete" name="delete" class="btn btn-outline-danger my-2 my-sm-0" type="submit">Delete</button>
                                </form>
                            </td>
